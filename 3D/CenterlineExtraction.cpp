...
template DLLEXPORT unsigned int CenterlineExtraction<float>(float *data, int width, int height, int depth, int max_segment_length, int smoothing_span, float **out_x, float **out_y, float **out_z, unsigned int **out_idx);
